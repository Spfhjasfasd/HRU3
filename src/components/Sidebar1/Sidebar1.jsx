...
import MoonbaseLogoImage from 'src/assets/images/Sidebar1_MoonbaseLogo.png';
import MoonbaseLogoMImage from 'src/assets/images/Sidebar1_MoonbaseLogo_M.png';
import Avatar1Image from 'src/assets/images/Sidebar1_Avatar.png';
  ...
  return (
    <CollapsableOpen>
      <Top>
        <Logo>
          <MoonbaseLogo
            src={MoonbaseLogoImage}
            loading="lazy"
            alt={'MoonbaseLogo'}
          />
          <MoonbaseLogoM
            src={MoonbaseLogoMImage}
            loading="lazy"
            alt={'MoonbaseLogo_M'}
          />
        </Logo>
